...
public class ShoppingCart{
    ...
    public static class Item {
        ...
        /* Created constructors to test Item class more effectively */
        public Item() {}
    ...
    public static void main(String[] args){
        ...
        System.out.println(calculateDiscount(new Item("smth", 100.00, 50, ShoppingCart.ITEM_FOR_SALE)));
    }
     ...
     * @param type      item type, on of lab3.ShoppingCart.ITEM_* constants
     *
